...
<?php
		...
		if(isset($_POST['eliminarEvento']))
		{
			...
			$conexion = mysqli_connect("www.tijuanatequilaalmeria.com" , "tijuana" , "tequila");
			mysqli_select_db("mydb", $conexion);		
			mysqli_query($sSQL,$conexion) or die ("Error de servidor");
		...
		if(isset($_POST['ordenar']))
		{
			...
			setcookie("consultaOrden",$consulta,time()+86400);
		}
		else if(isset($_COOKIE['consultaOrden']))
		{
			$consulta = $_COOKIE['consultaOrden'];
		}
		//echo $consulta;
		mostrar($consulta);
		?>
