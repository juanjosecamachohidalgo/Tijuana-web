...
if(!preg_match("/(^[a-zA-Z0-9]+)$/",$var)) return $this->error(true, "El nombre de la variable indicado contiene caracteres no válidos");
        ...
        */
        function ejecutar () {
                ...
                if(!empty($this->sql)) {
                        $result =(isset($this->conn)) ? @mysqli_query($this->conn, $this->sql) : mysqli_query($conexion, $this->sql);
                ...
                if($this->numTotalRegistros >= 1) {
                        ...
                        if(!empty($this->sql)) {
                                ...
                                $result = (isset($this->conn)) ? @mysql_query($sql, $this->conn) : @mysqli_query($conexion, $sql);
